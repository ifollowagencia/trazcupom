...
class CatchesControllerTest < ActionController::TestCase
  ...
  test "should create catch" do
    assert_difference('Catch.count') do
      post :create, catch: { dateend: @catch.dateend, dateinit: @catch.dateinit, offer_id: @catch.offer_id }
    end
  ...
  test "should update catch" do
    patch :update, id: @catch, catch: { dateend: @catch.dateend, dateinit: @catch.dateinit, offer_id: @catch.offer_id }
    assert_redirected_to catch_path(assigns(:catch))
  end
